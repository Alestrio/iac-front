  ...
  <div class="h-screen">
    ...
    <div class="w-full flex flex-col md:flex-row h-full">
      <div
        ...
        class="bg-white z-50 fixed w-full md:w-1/6 md:h-full shadow-xl hidden"
        id="nav"
      >
            ...
            <div class="flex flex-col justify-center">
              ...
              <div class="mb-3">
                ...
                >
                  ...
                  <option
                    v-for="proj in this.gcp_projects"
                    :value="proj"
                    :key="proj"
                  >
                    {{ proj }}
...
<script>
  ...
  export default {
    ...
    mounted() {
      ...
      axios.get(api_addr + "/settings/project/gcp").then((response) => {
      ...
      axios.get(api_addr + "/settings/projects/gcp").then((response) => {
